...
> ⚠️ **近期重要提示**：智谱 GLM Coding 订阅目前供不应求，脚本能力有限，订阅接口持续限流，高频请求可能适得其反，当前成功订阅概率较低。**请勿滥用脚本**，可能连续数月也抢不到，不必投入太多精力，建议耐心等待官方补充算力。
...
本项目仅用于**本地 OCR、自动化辅助及技术学习与研究**，请务必遵守目标网站（智谱 BigModel）的服务条款以及所在地的相关法律法规，**因使用本脚本产生的一切后果由使用者自行承担**。